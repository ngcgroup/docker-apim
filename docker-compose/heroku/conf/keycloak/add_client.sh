...
KC_AUTH_TOKEN=$(curl --location --request POST 'https://iam.bhn.technology/auth/realms/apistudio/protocol/openid-connect/token' \
...
curl --location --request POST 'https://iam.bhn.technology/auth/admin/realms/apistudio/users' \
--header 'Content-Type: application/json' \
--header "Authorization: Bearer ${KC_AUTH_TOKEN}" \
--data-raw '{"firstName":"John","lastName":"Ruben", "email":"test@test.com", "enabled":"true", "username":"john.ruben"}'